  ...
  return (
    ...
    >
      ...
      <FadeInView component={motion.p}>
        ...
        creatives or designers so I wanted the illustrations to reflect that.
      </FadeInView>
      <FadeInView component={motion.img} src="/illustration3.png" />
      <FadeInView component={motion.p}>
      ...
      <FadeInView component={motion.img} src="/illustration4.png" />
      <FadeInView component={motion.p}>
        Initial sketches for empty and 404 illustrations for Google Ads Creative
        Studio, an app where creatives can work on an ad campaign. Because the
        audience was creatives, I wanted that reflected in the sketches.
      </FadeInView>
      <FadeInView component={motion.img} src="/illustration5.png" />
      <FadeInView component={motion.p}>
        Hero sketches for Google Ads Creative Studio's onboarding page. I wanted
        to convey a sense of energy and action, getting users to move forward
        with the onboarding process, while associating the feeling of being able
        to do anything with Creative Studio.
      </FadeInView>
      <FadeInView component={motion.img} src="/illustration6.png" />
      <FadeInView component={motion.p}>
      ...
      <FadeInView
        ...
        src="/illustration7.png"
        style={{ maxWidth: 500 }}
      />
      <FadeInView component={motion.p}>
        Iterations on artistic style. Being an internal product, there were many
        directions that I could go with color, level of detail, stroke, etc.
      </FadeInView>
      <FadeInView
      ...
      <FadeInView
        ...
        style={{ maxWidth: 400 }}
      />
      <FadeInView component={motion.p} style={{ margin: 32 }}>
      ...
      />
      <FadeInView component={motion.p}>
        Final illustrations for Creative Studio.
      </FadeInView>
      {/* <FadeInView component={motion.img} src="/illustration10.png" /> */}
      <br />
      <br />
      <br />
    </motion.div>
